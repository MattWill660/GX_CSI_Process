...
classdef NMR_TimeFit < spec.NMR_Fit
    methods
        ...
        function [fit_area, fit_freq, fit_fwhm, fit_phase, ci_area, ...
            ...
            largestPeakFit = spec.NMR_TimeFit(residualTimeDomainSignal, obj.t, ...
        ...
        function copyObj = copyFitObject(obj)
            ...
            % Create object
            copyObj = spec.NMR_TimeFit(timeSig, obj.t, ...
        ...
        function realImagSig = calcConstrainedTimeSig(obj,nmr_params,t)
            ...
            tmpNmrMix = spec.NMR_Mix(nmr_params(1,:), nmr_params(2,:), ...
